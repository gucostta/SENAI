"""
4. O Sr. Manoel Joaquim possui uma grande loja de artigos de R$ 1,99, com cerca de 10
...
# Definir o preço unitário do item
preco_unitario = 1.99

# Imprimir o cabeçalho da tabela
print("Lojas Quase Dois - Tabela de preços")

# Gerar e imprimir a tabela de preços
for quantidade in range(1, 51):
    total_preco = quantidade * preco_unitario
    print(f"{quantidade} - R$ {total_preco:.2f}")
